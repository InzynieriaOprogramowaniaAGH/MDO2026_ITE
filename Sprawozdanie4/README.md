...
![Tworzenie woluminów wejściowych i wyjściowych](obrazy/01_woluminy.png)
![Uruchomienie kontenera z mapowaniem Bind Mount](obrazy/02_1_bind-mount.png)
...
![Kompilacja kodu i zapis na wolumin wyjściowy](obrazy/02_2_bind-mount.png)
...
![Klonowanie repozytorium do woluminu wewnątrz kontenera](obrazy/03_1_git.png)
...
![Weryfikacja trwałości danych w woluminie za pomocą kontenera Alpine](obrazy/03_2_git.png)
...
![Test wydajności sieci i komunikacja po nazwie kontenera](obrazy/04_iperf.png)
...
![Instalacja i konfiguracja serwera SSH w kontenerze](obrazy/05_1_openssh.png)
![Uruchomienie demona sshd i ustawienie uprawnień](obrazy/05_2_openssh.png)

Połączenie z hosta do kontenera zakończyło się sukcesem.

![Udane logowanie SSH do wnętrza kontenera](obrazy/05_3_openssh.png)
...
![Uruchomienie Jenkinsa wraz z pomocnikiem DinD](obrazy/06_1_jenkins.png)
...
![Ekran odblokowania Jenkinsa](obrazy/06_2_jenkins.png)
![Ekran wyboru wtyczek po zainicjalizowaniu instancji](obrazy/06_3_jenkins.png)
...
![Wykaz działających kontenerów Jenkinsa i usług pomocniczych](obrazy/07_kontenery.png)