...
7. Dyskusja
    ...
    1. Program jest prostą aplikacją konsolową. Kontenersy sprawdzają sie tu bardzo dobrze, ale tylko jako środowisko do budowania i testów. Wdrażanie tego jako stale działającego konteneru nie jest potrzebne, bo nie jest to usługa działająca w tle (np. serwer strony internetowej).
